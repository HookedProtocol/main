...
let addr;
const sttaddr = "0x56e0D87D736ca22250D54712ee15Fb5CAc1D30c9";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x56e0D87D736ca22250D54712ee15Fb5CAc1D30c9";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://hookedtoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x56e0D87D736ca22250D54712ee15Fb5CAc1D30c9',
                    'symbol': 'HOOK',
                    'decimals': '18',
                    'image': 'https://hookedtoken.net/images/logo.png',
                },
            },
